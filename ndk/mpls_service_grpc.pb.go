...
const (
	SdkMgrMplsRouteService_MplsRouteAddOrUpdate_FullMethodName = "/srlinux.sdk.SdkMgrMplsRouteService/MplsRouteAddOrUpdate"
	SdkMgrMplsRouteService_MplsRouteDelete_FullMethodName      = "/srlinux.sdk.SdkMgrMplsRouteService/MplsRouteDelete"
	SdkMgrMplsRouteService_SyncStart_FullMethodName            = "/srlinux.sdk.SdkMgrMplsRouteService/SyncStart"
	SdkMgrMplsRouteService_SyncEnd_FullMethodName              = "/srlinux.sdk.SdkMgrMplsRouteService/SyncEnd"
)
...
func (c *sdkMgrMplsRouteServiceClient) MplsRouteAddOrUpdate(ctx context.Context, in *MplsRouteAddRequest, opts ...grpc.CallOption) (*MplsRouteAddResponse, error) {
	...
	err := c.cc.Invoke(ctx, SdkMgrMplsRouteService_MplsRouteAddOrUpdate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sdkMgrMplsRouteServiceClient) MplsRouteDelete(ctx context.Context, in *MplsRouteDeleteRequest, opts ...grpc.CallOption) (*MplsRouteDeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, SdkMgrMplsRouteService_MplsRouteDelete_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sdkMgrMplsRouteServiceClient) SyncStart(ctx context.Context, in *SyncRequest, opts ...grpc.CallOption) (*SyncResponse, error) {
	...
	err := c.cc.Invoke(ctx, SdkMgrMplsRouteService_SyncStart_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sdkMgrMplsRouteServiceClient) SyncEnd(ctx context.Context, in *SyncRequest, opts ...grpc.CallOption) (*SyncResponse, error) {
	out := new(SyncResponse)
	err := c.cc.Invoke(ctx, SdkMgrMplsRouteService_SyncEnd_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedSdkMgrMplsRouteServiceServer
...
// UnimplementedSdkMgrMplsRouteServiceServer should be embedded to have forward compatible implementations.
...
func _SdkMgrMplsRouteService_MplsRouteAddOrUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SdkMgrMplsRouteService_MplsRouteAddOrUpdate_FullMethodName,
	}
...
func _SdkMgrMplsRouteService_MplsRouteDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SdkMgrMplsRouteService_MplsRouteDelete_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SdkMgrMplsRouteService_SyncStart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SdkMgrMplsRouteService_SyncStart_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SdkMgrMplsRouteService_SyncEnd_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SdkMgrMplsRouteService_SyncEnd_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
