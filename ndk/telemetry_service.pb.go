...
type TelemetryUpdateResponse struct {
	...
	Status   SdkMgrStatus `protobuf:"varint,1,opt,name=status,proto3,enum=ndk.SdkMgrStatus" json:"status,omitempty"` // Status of telemetry update request
...
type TelemetryDeleteResponse struct {
	...
	Status   SdkMgrStatus `protobuf:"varint,1,opt,name=status,proto3,enum=ndk.SdkMgrStatus" json:"status,omitempty"` // Status of delete request
	ErrorStr string       `protobuf:"bytes,2,opt,name=error_str,json=errorStr,proto3" json:"error_str,omitempty"`    // Detailed error message
}
...
var file_ndk_telemetry_service_proto_rawDesc = []byte{
	...
	,
	...
	0x52, 0x08, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x53, 0x74, 0x72, 0x22, 0x3d, 0x0a, 0x16, 0x54, 0x65,
	0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x23, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x11, 0x2e, 0x6e, 0x64, 0x6b, 0x2e, 0x54, 0x65, 0x6c, 0x65, 0x6d, 0x65, 0x74, 0x72,
	0x79, 0x4b, 0x65, 0x79, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x22, 0x61, 0x0a, 0x17, 0x54, 0x65, 0x6c,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x6e, 0x64, 0x6b, 0x2e, 0x53, 0x64, 0x6b, 0x4d, 0x67,
	...
	,
...
var file_ndk_telemetry_service_proto_goTypes = []interface{}{
	(*TelemetryKey)(nil),            // 0: ndk.TelemetryKey
	(*TelemetryData)(nil),           // 1: ndk.TelemetryData
	(*TelemetryInfo)(nil),           // 2: ndk.TelemetryInfo
	(*TelemetryUpdateRequest)(nil),  // 3: ndk.TelemetryUpdateRequest
	(*TelemetryUpdateResponse)(nil), // 4: ndk.TelemetryUpdateResponse
	(*TelemetryDeleteRequest)(nil),  // 5: ndk.TelemetryDeleteRequest
	(*TelemetryDeleteResponse)(nil), // 6: ndk.TelemetryDeleteResponse
	(SdkMgrStatus)(0),               // 7: ndk.SdkMgrStatus
}
var file_ndk_telemetry_service_proto_depIdxs = []int32{
	0, // 0: ndk.TelemetryInfo.key:type_name -> ndk.TelemetryKey
	1, // 1: ndk.TelemetryInfo.data:type_name -> ndk.TelemetryData
	2, // 2: ndk.TelemetryUpdateRequest.state:type_name -> ndk.TelemetryInfo
	7, // 3: ndk.TelemetryUpdateResponse.status:type_name -> ndk.SdkMgrStatus
	0, // 4: ndk.TelemetryDeleteRequest.key:type_name -> ndk.TelemetryKey
	7, // 5: ndk.TelemetryDeleteResponse.status:type_name -> ndk.SdkMgrStatus
	3, // 6: ndk.SdkMgrTelemetryService.TelemetryAddOrUpdate:input_type -> ndk.TelemetryUpdateRequest
	5, // 7: ndk.SdkMgrTelemetryService.TelemetryDelete:input_type -> ndk.TelemetryDeleteRequest
	4, // 8: ndk.SdkMgrTelemetryService.TelemetryAddOrUpdate:output_type -> ndk.TelemetryUpdateResponse
	6, // 9: ndk.SdkMgrTelemetryService.TelemetryDelete:output_type -> ndk.TelemetryDeleteResponse
